...
class UserServiceTest {
    ...
    void shouldCreateNewUser() {
        ...
        doReturn(createdUserEntity).when(userRepository).save(any());
        ...
        assertEquals(request.name(), createdUserDto.getName());
        assertEquals(request.email(), createdUserDto.getEmail());
        assertEquals(request.oauthUser(), createdUserDto.getOauthUser());
        assertEquals(request.profileUrl(), createdUserDto.getProfileUrl());
        assertEquals(request.authenticationType(), createdUserDto.getAuthenticationType());
        assertEquals(request.role(), createdUserDto.getRole());
    }
    ...
    void shouldUpdateExistingUser() {
        ...
        assertEquals(request.name(), updatedUserDto.getName());
        assertEquals(request.email(), updatedUserDto.getEmail());
        assertNull(updatedUserDto.getOauthUser());
        assertNull(updatedUserDto.getProfileUrl());
        assertNotNull(updatedUserDto.getAuthenticationType());
        assertEquals(request.role(), updatedUserDto.getRole());
    }
